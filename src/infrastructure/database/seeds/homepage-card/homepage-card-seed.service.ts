...
export class HomepageCardSeedService {
  ...
  async run() {
    await this.createHomepageCard(
      ...
      "FOR_YOU",
        "https://formation-agent-securite.net/devenir-videur-de-boite-de-nuit/");
    await this.createHomepageCard(
    ...
    await this.createHomepageCard(
      ...
      "JOBS",
        "https://www.instagram.com/neon_niteclub/");
  }

  private async createHomepageCard(title: string, description: string, photo: string, type: string, link?: string) {
