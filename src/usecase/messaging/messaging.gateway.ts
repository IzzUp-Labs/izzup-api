...
export class MessagingGateway implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect {
  ...
  async create(@ConnectedSocket() client: Socket, @MessageBody("content") content: string, @MessageBody("authorId") authorId: string, @MessageBody("roomId") roomId: string) {
  ...
  async typing(@ConnectedSocket() client: Socket, @MessageBody("userId") userId: string, @MessageBody("roomId") roomId: string, @MessageBody("isTyping") isTyping: boolean) {
