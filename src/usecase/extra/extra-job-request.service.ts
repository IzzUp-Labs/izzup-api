...
export class ExtraJobRequestService {
  ...
  async create(jobOfferId: string, userId: string) {
  ...
  findAllJobRequestsByJobOfferId(jobOfferId: string) {
  ...
  update(id: string, extraJobRequestDto: ExtraJobRequestDto) {
  ...
  rejectRemainingRequests(requestIds: string[]) {
  ...
  async rejectExtraRequestWhenAccepted(extraId: string, jobOffer: JobOfferEntity) {
